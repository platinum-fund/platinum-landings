      ...
      <div className="wrapper_shrink">
        <div className="headline">
          <h2 className="title title_type_section">
            <FormattedHTMLMessage
              id="comparingToAnotherFundingType"
              defaultMessage={'comparingToAnotherFundingType'}
            />
          </h2>
        </div>
        ...
        <div className="headline">
          <h4 className="title title_type_second">
            <FormattedHTMLMessage id="getYou" defaultMessage={'getYou'} />
          </h4>
          <h4 className="title title_type_second _orange">
            <FormattedHTMLMessage
              id="freeConsultation"
              defaultMessage={'freeConsultation'}
            />
          </h4>
          <h4 className="title title_type_second">
            <FormattedHTMLMessage id="and" defaultMessage={'and'} />
          </h4>
          <h4 className="title title_type_second _orange">
            <FormattedHTMLMessage
              id="projectReview"
              defaultMessage={'projectReview'}
            />
          </h4>
        </div>
